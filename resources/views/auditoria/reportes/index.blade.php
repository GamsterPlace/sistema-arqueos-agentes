...
<div class="page-header">
    <div class="page-title">
        ...
        <p>
            ...
            y comportamiento operativo por Agente, Ruta y Región.
        </p>
    </div>
</div>
...
<div class="report-grid">
    @php
        $descripciones = [
            ...
            'historial-auditoria' => 'Historial de arqueos realizados por Auditoría.',
    ...
    @foreach($tiposReporte as $clave => $nombre)
        <a
            href="{{ route('auditoria.reportes.index', array_merge(
                request()->except('page'),
                ['reporte' => $clave]
            )) }}"
...
<section class="filters-card">
    <form method="GET" action="{{ route('auditoria.reportes.index') }}">
