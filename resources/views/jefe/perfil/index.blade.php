...
<div class="page-header">
    <div class="page-title">
        <h2>Perfil del Jefe de Agentes</h2>

        <p>
            Consulte la información de su cuenta
            y el resumen operativo general del sistema.
        </p>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="security-box">
                    <div>
                        ...
                        <p>
                            Utilice el módulo de cambio
                            de contraseña para actualizar
