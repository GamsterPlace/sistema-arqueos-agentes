...
<div class="create-agent-page">
    <div class="create-header">
        <div class="create-title">
            ...
            <div>
                <h2>Crear Agente</h2>
                <p>
                    Registre la información operativa del Agente MICOOPE y cree su cuenta
                    institucional de acceso en una sola operación.
                </p>
            </div>
        </div>
    ...
    <form
        method="POST"
        action="{{ route('administrador.agentes.store') }}"
        class="form-shell"
    >
        @csrf
        ...
        <section class="form-section">
            <div class="section-heading">
                ...
                <div>
                    ...
                    <p>Credenciales e información personal vinculadas al nuevo agente.</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-field full">
                    ...
                    >
                    <span class="field-help">
                        Este será el usuario utilizado para iniciar sesión en el sistema.
                    </span>
                </div>
        ...
        <footer class="form-footer">
            <div class="form-footer-note">
                ...
                Los datos se registrarán como parte de la administración institucional.
            </div>
