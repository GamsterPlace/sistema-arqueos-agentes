...
<form method="GET" action="{{ route('gerencia.arqueos-promotores.index') }}" style="padding:18px;border:1px solid #e0e8ee;border-radius:18px;background:#fff;margin-bottom:20px;">
